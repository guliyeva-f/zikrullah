...
class AppColors {
  ...
  static const bgCard = Color(0xFFF2EDE6);
  static const bgElevated = Color(0xFFEDE8E0);

  static const textPrimary = Color(0xFF2D2620);
  static const textSecondary = Color(0xFF8A7E72);
  static const textHint = Color(0xFFB5A898);
